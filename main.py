...
PRICE_CHANGE_THRESHOLD = 0.4  # ±% price change for 5m candle
...
def get_bybit_data():
    ...
    try:
        ...
        for symbol in symbols:
            ...
            if len(k_data) >= 3:
                o = float(k_data[-2][1])  # Open price of the last closed candle
                c = float(k_data[-2][4])  # Close price of the last closed candle
                change = ((c - o) / o) * 100
...
# === MAIN LOOP ===
print("✅ Bot running... watching Bybit 5m candle price changes ≥ ±0.4%")
while True:
